...
| 组件 | 标签前缀 | 示例 | 包含内容 |
|------|----------|------|----------|
| Framework | `fw-` | `fw-4.35.0` | 模板（12 种类型）、治理文档、指令、Charter 模板 + schema |
| CLI | `cli-` | `cli-3.35.0` | `straymark` 二进制文件 |

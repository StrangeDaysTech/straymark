...
|------------|---------------|---------|---------|
| Framework | `fw-` | `fw-4.16.2` | Plantillas (12 tipos), gobernanza, directivas, plantilla + schema de Charter |
| CLI | `cli-` | `cli-3.14.1` | El binario `straymark` |
...
# y descarga el último release fw-* (ej. fw-4.16.2)

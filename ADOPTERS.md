...
| Estoa (private: `StrangeDaysTech/estoa`) | Strange Days Tech | ASP.NET / PostgreSQL modular platform; development governed with StrayMark and SpecKit | fw-4.44.0 | Manual, sanitized development aggregates; Baton Track C classification discrepancies, reproducible findings and bounded PRs | [#426](https://github.com/StrangeDaysTech/straymark/discussions/426) | **N=2 candidate** for Baton's declared work-verb classification ([#332](https://github.com/StrangeDaysTech/straymark/issues/332)) — second domain vs Sentinel's Go backend; Track C calibration pending |

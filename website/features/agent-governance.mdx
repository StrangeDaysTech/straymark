...
- **Same contract across CLIs.** The same `STRAYMARK.md` directs Claude Code, Antigravity CLI, Copilot CLI, Codex CLI. One source of truth, N agents. Switching models doesn't mean rewriting the operating contract.

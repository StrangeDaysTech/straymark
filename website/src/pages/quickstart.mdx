...
Or, equivalently, from inside an agent CLI (Claude Code, Antigravity CLI, Copilot CLI, ...):
...
Open auditor-side CLIs (Claude Code, Copilot CLI, Antigravity CLI, Codex CLI — pick any combination). In each, run:

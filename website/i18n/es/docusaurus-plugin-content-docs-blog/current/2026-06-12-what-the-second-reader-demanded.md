...
Entonces el pivote de verdad: [`cli-3.23.1`](https://github.com/StrangeDaysTech/straymark/releases/tag/cli-3.23.1), registrado en [`ADR-2026-06-02-001`](https://github.com/StrangeDaysTech/straymark/blob/main/.straymark/02-design/decisions/ADR-2026-06-02-001-loom-stack.md), hito M0 de Loom.

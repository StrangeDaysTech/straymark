...
| **2 — Clasificación + router en seco** ✅ **HECHA (2026-06-26)** | Esquema de clasificación barato; router que **recomienda** (no ejecuta); telemetría de "qué iría a qué tier"; experimentar granularidad de unidad enrutable en Sentinel | Visibilidad económica + validación del principio de §4.2, sin riesgo. Techo de ahorro ~93% (ilustrativo); hallazgo: **la cobertura de señal, no la granularidad, es la palanca** (CHARTER-03, `04-phase2-dry-run-dogfood.md`) | Solo telemetría |
